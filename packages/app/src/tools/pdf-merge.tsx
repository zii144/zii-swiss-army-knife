...
const L = {
  en: {
    ...
    merge: 'Merge',
    merging: 'Merging…',
    none: 'Add two or more PDF files to merge.',
...
export default function PdfMergeTool({ onBack, lang, backLabel, offlineLabel }: ToolViewProps) {
  const t = tr(L, lang);
  ...
  const run = async (): Promise<void> => {
    ...
    try {
      ...
      setResult(await mergePdfs(inputs));
    } catch (e) {
