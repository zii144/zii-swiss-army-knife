...
import { itInpsEmployee, IT_2026 } from '@zii/payroll';
...
const L = {
  en: {"title":"Italy INPS","desc":"Estimate employee INPS social contribution (~9.19%). On-device.","gross":"Annual gross (€)","inps":"Employee INPS"},
};
const num = (n: number) =>
...
export default function Tool({ onBack, lang, backLabel, offlineLabel }: ToolViewProps) {
  ...
  const r = { inps: itInpsEmployee(gross) };
  return (
