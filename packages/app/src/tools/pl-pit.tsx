...
import { plPitAnnual, PL_2026 } from '@zii/payroll';
...
const L = {
  en: {"title":"Poland PIT","desc":"Rough PIT on taxable annual income (12% / 32% simplified). On-device.","input":"Taxable income (PLN / year)","out":"Estimated PIT"},
};
const num = (n: number) =>
