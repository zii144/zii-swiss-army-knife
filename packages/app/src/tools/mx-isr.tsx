...
import { mxIsrAnnual, MX_2026 } from '@zii/payroll';
...
const L = {
  en: {"title":"Mexico ISR","desc":"Rough ISR on taxable annual income (2026 simplified brackets). On-device.","input":"Taxable income (MXN / year)","out":"Estimated ISR"},
};
const num = (n: number) =>
