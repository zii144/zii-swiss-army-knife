...
const LOADERS: Record<string, ViewLoader> = {
  ...
  'ca-takehome': () => import('./ca-takehome'),
  'ca-income-tax': () => import('./ca-income-tax'),
  'ca-cpp': () => import('./ca-cpp'),
  'ca-ei': () => import('./ca-ei'),
  'ca-gst-hst': () => import('./ca-gst-hst'),
  'ca-rrsp': () => import('./ca-rrsp'),
  'ca-tfsa': () => import('./ca-tfsa'),
  'ca-postal': () => import('./ca-postal'),
  'ca-transit': () => import('./ca-transit'),
  'au-takehome': () => import('./au-takehome'),
  'au-help': () => import('./au-help'),
  'au-medicare': () => import('./au-medicare'),
  'au-super': () => import('./au-super'),
  'au-gst': () => import('./au-gst'),
  'au-abn': () => import('./au-abn'),
  'au-bsb': () => import('./au-bsb'),
  'au-postcode': () => import('./au-postcode'),
  'au-leave': () => import('./au-leave'),
  'ko-takehome': () => import('./ko-takehome'),
  'ko-four-insurances': () => import('./ko-four-insurances'),
  'ko-severance': () => import('./ko-severance'),
  'ko-annual-leave': () => import('./ko-annual-leave'),
  'ko-overtime': () => import('./ko-overtime'),
  'ko-brn': () => import('./ko-brn'),
  'ko-rrn': () => import('./ko-rrn'),
  'ko-postal': () => import('./ko-postal'),
  'ko-phone': () => import('./ko-phone'),
  'ko-vat': () => import('./ko-vat'),
  'de-takehome': () => import('./de-takehome'),
  'de-income-tax': () => import('./de-income-tax'),
  'de-vat': () => import('./de-vat'),
  'de-iban': () => import('./de-iban'),
  'de-plz': () => import('./de-plz'),
  'de-tax-id': () => import('./de-tax-id'),
  'de-holidays': () => import('./de-holidays'),
  'de-vacation': () => import('./de-vacation'),
  'de-commute': () => import('./de-commute'),
  'de-severance': () => import('./de-severance'),
  'fr-brut-net': () => import('./fr-brut-net'),
  'fr-employer-cost': () => import('./fr-employer-cost'),
  'fr-pas': () => import('./fr-pas'),
  'fr-tva': () => import('./fr-tva'),
  'fr-iban-rib': () => import('./fr-iban-rib'),
  'fr-siren-siret': () => import('./fr-siren-siret'),
  'fr-nir': () => import('./fr-nir'),
  'fr-code-postal': () => import('./fr-code-postal'),
  'fr-holidays': () => import('./fr-holidays'),
  'fr-conges': () => import('./fr-conges'),
  'es-takehome': () => import('./es-takehome'),
  'es-irpf': () => import('./es-irpf'),
  'es-ss': () => import('./es-ss'),
  'es-iva': () => import('./es-iva'),
  'es-vacation': () => import('./es-vacation'),
  'es-holidays': () => import('./es-holidays'),
  'es-dni': () => import('./es-dni'),
  'es-cif': () => import('./es-cif'),
  'es-iban': () => import('./es-iban'),
  'es-postal': () => import('./es-postal'),
  'it-takehome': () => import('./it-takehome'),
  'it-irpef': () => import('./it-irpef'),
  'it-inps': () => import('./it-inps'),
  'it-iva': () => import('./it-iva'),
  'it-tfr': () => import('./it-tfr'),
  'it-holidays': () => import('./it-holidays'),
  'it-codice-fiscale': () => import('./it-codice-fiscale'),
  'it-partita-iva': () => import('./it-partita-iva'),
  'it-iban': () => import('./it-iban'),
  'it-cap': () => import('./it-cap'),
  'nl-takehome': () => import('./nl-takehome'),
  'nl-loonheffing': () => import('./nl-loonheffing'),
  'nl-holiday-allowance': () => import('./nl-holiday-allowance'),
  'nl-btw': () => import('./nl-btw'),
  'nl-vacation': () => import('./nl-vacation'),
  'nl-holidays': () => import('./nl-holidays'),
  'nl-bsn': () => import('./nl-bsn'),
  'nl-kvk': () => import('./nl-kvk'),
  'nl-iban': () => import('./nl-iban'),
  'nl-postcode': () => import('./nl-postcode'),
  'sg-takehome': () => import('./sg-takehome'),
  'sg-cpf': () => import('./sg-cpf'),
  'sg-income-tax': () => import('./sg-income-tax'),
  'sg-gst': () => import('./sg-gst'),
  'sg-leave': () => import('./sg-leave'),
  'sg-holidays': () => import('./sg-holidays'),
  'sg-nric': () => import('./sg-nric'),
  'sg-uen': () => import('./sg-uen'),
  'sg-postal': () => import('./sg-postal'),
  'sg-phone': () => import('./sg-phone'),
  'in-takehome': () => import('./in-takehome'),
  'in-income-tax': () => import('./in-income-tax'),
  'in-epf': () => import('./in-epf'),
  'in-gst': () => import('./in-gst'),
  'in-holidays': () => import('./in-holidays'),
  'in-pan': () => import('./in-pan'),
  'in-aadhaar': () => import('./in-aadhaar'),
  'in-gstin': () => import('./in-gstin'),
  'in-ifsc': () => import('./in-ifsc'),
  'in-pincode': () => import('./in-pincode'),
  'pt-takehome': () => import('./pt-takehome'),
  'pt-irs': () => import('./pt-irs'),
  'pt-ss': () => import('./pt-ss'),
  'pt-iva': () => import('./pt-iva'),
  'pt-vacation': () => import('./pt-vacation'),
  'pt-holidays': () => import('./pt-holidays'),
  'pt-nif': () => import('./pt-nif'),
  'pt-iban': () => import('./pt-iban'),
  'pt-postal': () => import('./pt-postal'),
  'pt-phone': () => import('./pt-phone'),
  'br-takehome': () => import('./br-takehome'),
  'br-irpf': () => import('./br-irpf'),
  'br-inss': () => import('./br-inss'),
  'br-fgts': () => import('./br-fgts'),
  'br-vacation': () => import('./br-vacation'),
  'br-holidays': () => import('./br-holidays'),
  'br-cpf': () => import('./br-cpf'),
  'br-cnpj': () => import('./br-cnpj'),
  'br-cep': () => import('./br-cep'),
  'br-phone': () => import('./br-phone'),
  'mx-takehome': () => import('./mx-takehome'),
  'mx-isr': () => import('./mx-isr'),
  'mx-imss': () => import('./mx-imss'),
  'mx-iva': () => import('./mx-iva'),
  'mx-vacation': () => import('./mx-vacation'),
  'mx-holidays': () => import('./mx-holidays'),
  'mx-rfc': () => import('./mx-rfc'),
  'mx-curp': () => import('./mx-curp'),
  'mx-postal': () => import('./mx-postal'),
  'mx-clabe': () => import('./mx-clabe'),
  'pl-takehome': () => import('./pl-takehome'),
  'pl-pit': () => import('./pl-pit'),
  'pl-zus': () => import('./pl-zus'),
  'pl-vat': () => import('./pl-vat'),
  'pl-vacation': () => import('./pl-vacation'),
  'pl-holidays': () => import('./pl-holidays'),
  'pl-pesel': () => import('./pl-pesel'),
  'pl-nip': () => import('./pl-nip'),
  'pl-iban': () => import('./pl-iban'),
  'pl-postal': () => import('./pl-postal'),
  'nz-takehome': () => import('./nz-takehome'),
  'nz-income-tax': () => import('./nz-income-tax'),
  'nz-kiwisaver': () => import('./nz-kiwisaver'),
  'nz-gst': () => import('./nz-gst'),
  'nz-leave': () => import('./nz-leave'),
  'nz-holidays': () => import('./nz-holidays'),
  'nz-ird': () => import('./nz-ird'),
  'nz-nzbn': () => import('./nz-nzbn'),
  'nz-postal': () => import('./nz-postal'),
  'nz-phone': () => import('./nz-phone'),
};
