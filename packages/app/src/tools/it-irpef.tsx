...
import { itIrpefAnnual, IT_2026 } from '@zii/payroll';
...
const L = {
  en: {"title":"Italy IRPEF","desc":"Rough IRPEF on taxable annual income (2026 simplified brackets). On-device.","taxable":"Taxable income (€ / year)","tax":"Estimated IRPEF"},
};
const num = (n: number) =>
...
export default function Tool({ onBack, lang, backLabel, offlineLabel }: ToolViewProps) {
  ...
  const r = { tax: itIrpefAnnual(taxable) };
  return (
