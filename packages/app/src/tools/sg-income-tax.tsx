...
import { sgIncomeTax, SG_2026 } from '@zii/payroll';
...
const L = {
  en: {"title":"Singapore income tax","desc":"Resident income tax on taxable income (2026 brackets). On-device.","taxable":"Taxable income (S$ / year)","tax":"Estimated tax"},
};
const num = (n: number) =>
...
export default function Tool({ onBack, lang, backLabel, offlineLabel }: ToolViewProps) {
  const t = tr(L, lang);
  const [taxable, setTaxable] = useState(60000);
  const r = { tax: sgIncomeTax(taxable) };
  return (
