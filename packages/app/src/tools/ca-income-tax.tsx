...
const L = {
  en: {
    ...
    desc: 'Estimate federal + provincial income tax (2026). Outside Ontario, provincial tax uses approximate flat rates — not CRA.',
    taxable: 'Taxable income (CAD)',
    province: 'Province',
    federal: 'Federal',
...
export default function Tool({ onBack, lang, backLabel, offlineLabel }: ToolViewProps) {
  ...
  const provincial = caProvincialTax(taxable, province as CaProvince);
  return (
