...
import { brIrpfAnnual, BR_2026 } from '@zii/payroll';
...
const L = {
  en: {"title":"Brazil IRPF","desc":"Rough IRPF on taxable annual income (2026 simplified brackets). On-device.","input":"Taxable income (R$ / year)","out":"Estimated IRPF"},
};
const num = (n: number) =>
...
export default function Tool({ onBack, lang, backLabel, offlineLabel }: ToolViewProps) {
  ...
  const r = { out: brIrpfAnnual(value) };
  return (
