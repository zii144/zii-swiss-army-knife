...
import { nlLoonheffing, NL_2026 } from '@zii/payroll';
...
const L = {
  en: {"title":"Netherlands loonheffing","desc":"Rough Box 1 loonheffing on annual gross (no heffingskorting). On-device.","gross":"Annual gross (€)","tax":"Estimated loonheffing"},
};
const num = (n: number) =>
...
export default function Tool({ onBack, lang, backLabel, offlineLabel }: ToolViewProps) {
  ...
  const r = { tax: nlLoonheffing(gross) };
  return (
