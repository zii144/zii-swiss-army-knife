...
import { ptSsEmployee, PT_2026 } from '@zii/payroll';
...
const L = {
  en: {"title":"Portugal social security","desc":"Estimate employee Segurança Social (~11% of gross). On-device.","input":"Annual gross (€)","out":"Employee SS"},
};
const num = (n: number) =>
...
export default function Tool({ onBack, lang, backLabel, offlineLabel }: ToolViewProps) {
  ...
  const r = { out: ptSsEmployee(value) };
  return (
