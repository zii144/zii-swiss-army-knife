...
import { generateQr } from '../lib/compute';
import { ToolPage, DownloadButton } from '../components/ToolPage';
import { tr, type ToolViewProps } from './shared';
...
export default function QrGenerate({ onBack, lang, backLabel, offlineLabel }: ToolViewProps) {
  const t = tr(L, lang);
